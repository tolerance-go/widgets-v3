      ...
      return (
        <>
          <Form.Item label="BackendFilteredSelect">
            {getFieldDecorator(`${tabItem.key}.BackendFilteredSelect`, {
              rules: [
                {
          ...
          <Form.Item label="Password" hasFeedback>
            {getFieldDecorator(
              `${tabItem.key}.password`,
              {},
            )(<Input.Password autoComplete="off" />)}
          </Form.Item>
          <Form.Item label="Confirm Password" hasFeedback>
            {getFieldDecorator(`${tabItem.key}.confirm`, {})(<Input.Password />)}
          </Form.Item>
          <Form.Item
            label={
              <span>
          ...
          >
            {getFieldDecorator(`${tabItem.key}.nickname`, {
              rules: [{ message: 'Please input your nickname!', whitespace: true }],
            })(<Input />)}
          </Form.Item>
          <Form.Item label="Habitual Residence">
            {getFieldDecorator(`${tabItem.key}.residence`, {
          ...
          <Form.Item label="EditableTable">
            {getFieldDecorator(`${tabItem.key}.res234234idence`, {
